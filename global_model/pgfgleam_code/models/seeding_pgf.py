...
Extension of SentinelPGF with separate tracking for:
    - cumulative_latent_importation (L)
    - cumulative_infectious_importation (I)
    - cumulative_post_infectious_importation (P)

This, in particular, is necessary for seeding into the local model; as I + P can be detected in AWW, but L + I can be seeded
to lead to local trasnmission

    Author: Guillaume St-Onge & Benjamin K. Reddy || <g.st-onge@northeastern.edu> & <benjamin.reddy@stats.ox.ac.uk> 
"""
